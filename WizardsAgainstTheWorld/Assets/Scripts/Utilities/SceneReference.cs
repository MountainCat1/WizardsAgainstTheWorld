    ...
    public class SceneReferencePropertyDrawer : PropertyDrawer
    {
            ...
            using (new EditorGUI.DisabledScope(readOnly))
            {
                ...
                else
                {
                    ...
                    tooltipMsg =
                        ...
                        readOnlyWarning;
                    if (DrawUtils.ButtonHelper(buttonRect, "Remove...", "Remove from Build",
                            EditorStyles.miniButtonMid, tooltipMsg))
        ...
        private static class BuildUtils
        {
            ...
            public static void SetBuildSceneState(BuildScene buildScene, bool enabled)
            {
                ...
                foreach (var curScene in scenesToModify.Where(
                             curScene => curScene.guid.Equals(buildScene.assetGUID)))
                {
